...
export default function ExpertNavbar() {
  ...
  <div class="container-fluid">
    ...
    <h4 style={{"color":"white"}}>Fit Pro</h4>
    <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
      <li class="nav-item">
        <a class="nav-link active" aria-current="page" href="/#/profile" style={{color: "white", marginRight:"50px"}}><h5>Profile</h5></a>
      </li>
      <li class="nav-item">
        <a class="nav-link active" href="/#/appointment" aria-current="page" style={{color: "white", marginRight:"50px"}}><h5>AddAppointment</h5></a>
      </li>
